...
%===========================================================================
%---------------------------------------------------------------------------
% Matlab Convolution GUI version 3.15 (24-Jun-2015)
%---------------------------------------------------------------------------
%   : MATLAB R2015a update (G Krudysz)
%---------------------------------------------------------------------------
% Matlab Convolution GUI version 3.12 (25-Jan-2015)
%---------------------------------------------------------------------------
%   : MATLAB R2014b update: mods to account for new graphics arch (G Krudysz)
%---------------------------------------------------------------------------
% Matlab Convolution GUI version 3.11 (21-Dec-2014)
%---------------------------------------------------------------------------
%   : MATLAB R2014a update: unit sample 'onmove' error, added fontsizedlg()
%      cosmetic updates: stem fills, spacing, 0-line (G Krudysz)
%---------------------------------------------------------------------------
% Matlab Convolution GUI version 3.10 (28-May-2009)
%---------------------------------------------------------------------------
